    ...
    while gap > 1 or echange:
        ...
        for i in range(0, n - gap):
            if liste_anim[i] > liste_anim[i + gap]:
                ...
                # INDISPENSABLE : On yield à chaque échange pour voir
                # les couleurs s'organiser progressivement
...
generateur = tri_peigne_anime(ma_liste)  # generateur contient la liste etape par etape
...
plt.title(f"Visualisation en direct du Tri par Peigne sur {nom_fichier}\n")
plt.show()
